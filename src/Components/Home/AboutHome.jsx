...
const AboutHome = () => {
  return (
    <section className='p-3 p-sm-5 row align-items-center justify-content-center gap-4 gx-0 mb-4 mb-sm-0'>
       ...
       <div className='col-lg-6'>
         <p className='subtitle mb-2'>About Us</p>
         <p className="lh-lg text-justify">{para1}</p>
         <NavLink to="/aboutus" className="common-btn shadow">Know More</NavLink>
       </div>
    </section>
  )
}
